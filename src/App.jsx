      ...
      <section className="py-20" style={{ background: "#3A4138" }}>
        <div className="max-w-5xl mx-auto px-6">
          ...
          <div className="grid md:grid-cols-3 gap-6">
            {[
              { title: "Sport & Performance", desc: "Supporting athletes, coaches, teams, and organisations, from community sport through to the high performance level, to build mental strength, resilience, and a consistent performance mindset.", tags: ["Individual Athletes", "Teams & Organisations", "High Performance"], grad: "linear-gradient(135deg,#492A34,#6b3d4a)", photo: photos.strand1 },
              { title: "Therapeutic Support", desc: "Individual sessions for people of all ages across mental health, life transitions, parenting, and neurodivergence, combining CBT, ACT, and strengths-based approaches.", tags: ["Anxiety & Mood", "Youth & Adults", "Neurodivergence"], grad: "linear-gradient(135deg,#8B9467,#6b7550)", photo: photos.strand2 },
              { title: "Educational Assessments", desc: "Comprehensive learning and behavioural assessments to help young people understand their strengths and get the support they need to thrive.", tags: ["Learning Assessments", "Behavioural", "School Consultation"], grad: "linear-gradient(135deg,#3A4138,#4e5a4b)", photo: photos.strand3 },
            ].map(c => (
